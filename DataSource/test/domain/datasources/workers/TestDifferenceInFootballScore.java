...
public class TestDifferenceInFootballScore {
	...
	public void test() {		
		...
		when(fetcher.getContent("http://api.everysport.com/v1/events?apikey=1769e0fdbeabd60f479b1dcaff03bf5c&league=nullfromDate=1999-01-01&toDate=2002-01-01&limit=1000")).thenReturn(json);
