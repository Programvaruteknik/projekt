...
public class TestFootballSpectators {
	...
	public void getData() {
		...
		when(fetcher.getContent("http://api.everysport.com/v1/events?apikey=1769e0fdbeabd60f479b1dcaff03bf5c&league=null&fromDate=startDate&toDate=endDate&limit=5000")).thenReturn(json);
